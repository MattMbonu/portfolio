...
var getCookieFromReq = function getCookieFromReq(req, cookie) {
  var correctCookie = req.headers.cookie.split(";").find(function (c) {
...
function () {
  function Auth0() {
    ...
    this.auth0 = new auth0_js__WEBPACK_IMPORTED_MODULE_1___default.a.WebAuth({
      domain: "dev-q55acmny.auth0.com",
      clientID: "Lheyj8sNhYCq8umVoDMLy5Jcb4HNzeWU",
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("https://dev-q55acmny.auth0.com/.well-known/jwks.json");
